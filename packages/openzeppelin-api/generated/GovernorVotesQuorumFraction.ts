...
export interface GovernorVotesQuorumFractionMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  BALLOT_TYPEHASH(overrides?: CallOverrides): Call<string>;

  COUNTING_MODE(overrides?: CallOverrides): Call<string>;

  EXTENDED_BALLOT_TYPEHASH(overrides?: CallOverrides): Call<string>;
  ...
  proposalThreshold(overrides?: CallOverrides): Call<BigNumber>;

  quorum(blockNumber: BigNumberish, overrides?: CallOverrides): Call<BigNumber>;

  quorumDenominator(overrides?: CallOverrides): Call<BigNumber>;
  ...
  "quorumNumerator()"(overrides?: CallOverrides): Call<BigNumber>;

  state(proposalId: BigNumberish, overrides?: CallOverrides): Call<number>;
  ...
  token(overrides?: CallOverrides): Call<string>;

  version(overrides?: CallOverrides): Call<string>;

  votingDelay(overrides?: CallOverrides): Call<BigNumber>;

  votingPeriod(overrides?: CallOverrides): Call<BigNumber>;
}
