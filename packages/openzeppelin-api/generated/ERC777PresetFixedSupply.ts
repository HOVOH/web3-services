...
export interface ERC777PresetFixedSupplyMulticall {
  address: string;
  abi: Fragment[];
  ...
  balanceOf(tokenHolder: string, overrides?: CallOverrides): Call<BigNumber>;

  decimals(overrides?: CallOverrides): Call<number>;

  defaultOperators(overrides?: CallOverrides): Call<string[]>;

  granularity(overrides?: CallOverrides): Call<BigNumber>;
