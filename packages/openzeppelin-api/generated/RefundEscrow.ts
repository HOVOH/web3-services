...
export interface RefundEscrowMulticall {
  address: string;
  abi: Fragment[];
  ...
  depositsOf(payee: string, overrides?: CallOverrides): Call<BigNumber>;

  owner(overrides?: CallOverrides): Call<string>;

  state(overrides?: CallOverrides): Call<number>;

  withdrawalAllowed(arg0: string, overrides?: CallOverrides): Call<boolean>;
}
