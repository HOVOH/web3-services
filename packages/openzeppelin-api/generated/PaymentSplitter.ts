...
export interface PaymentSplitterMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  payee(index: BigNumberish, overrides?: CallOverrides): Call<string>;
  ...
  shares(account: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  "totalReleased()"(overrides?: CallOverrides): Call<BigNumber>;

  totalShares(overrides?: CallOverrides): Call<BigNumber>;
}
