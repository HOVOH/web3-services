...
export interface ERC20VotesCompMulticall {
  address: string;
  abi: Fragment[];
  ...
  checkpoints(
    ...
    pos: BigNumberish,
    overrides?: CallOverrides
  ): Call<ERC20Votes.CheckpointStructOutput>;

  decimals(overrides?: CallOverrides): Call<number>;

  delegates(account: string, overrides?: CallOverrides): Call<string>;

  getCurrentVotes(account: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  numCheckpoints(account: string, overrides?: CallOverrides): Call<number>;
