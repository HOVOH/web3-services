...
export interface IERC1820RegistryMulticall {
  address: string;
  abi: Fragment[];
  ...
  getManager(account: string, overrides?: CallOverrides): Call<string>;
  ...
  interfaceHash(interfaceName: string, overrides?: CallOverrides): Call<string>;
}
