...
export interface IArbSysMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  arbBlockNumber(overrides?: CallOverrides): Call<BigNumber>;

  arbChainID(overrides?: CallOverrides): Call<BigNumber>;

  arbOSVersion(overrides?: CallOverrides): Call<BigNumber>;
  ...
  getStorageGasAvailable(overrides?: CallOverrides): Call<BigNumber>;
  ...
  isTopLevelCall(overrides?: CallOverrides): Call<boolean>;
  ...
  myCallersAddressWithoutAliasing(overrides?: CallOverrides): Call<string>;

  wasMyCallersAddressAliased(overrides?: CallOverrides): Call<boolean>;
}
