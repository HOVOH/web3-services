...
export interface IBridgeMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  activeOutbox(overrides?: CallOverrides): Call<string>;

  allowedInboxes(inbox: string, overrides?: CallOverrides): Call<boolean>;

  allowedOutboxes(outbox: string, overrides?: CallOverrides): Call<boolean>;

  inboxAccs(index: BigNumberish, overrides?: CallOverrides): Call<string>;

  messageCount(overrides?: CallOverrides): Call<BigNumber>;
}
