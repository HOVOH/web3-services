...
export interface GovernorCompatibilityBravoMulticall {
  address: string;
  abi: Fragment[];
  ...
  getReceipt(
    ...
    voter: string,
    overrides?: CallOverrides
  ): Call<IGovernorCompatibilityBravo.ReceiptStructOutput>;
  ...
  quorumVotes(overrides?: CallOverrides): Call<BigNumber>;
