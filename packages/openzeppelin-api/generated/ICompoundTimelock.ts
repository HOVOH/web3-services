...
export interface ICompoundTimelockMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  GRACE_PERIOD(overrides?: CallOverrides): Call<BigNumber>;

  MAXIMUM_DELAY(overrides?: CallOverrides): Call<BigNumber>;

  MINIMUM_DELAY(overrides?: CallOverrides): Call<BigNumber>;

  admin(overrides?: CallOverrides): Call<string>;

  delay(overrides?: CallOverrides): Call<BigNumber>;

  pendingAdmin(overrides?: CallOverrides): Call<string>;

  queuedTransactions(arg0: BytesLike, overrides?: CallOverrides): Call<boolean>;
}
