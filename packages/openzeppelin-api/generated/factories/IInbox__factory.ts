...
import type { IInbox, IInboxInterface, IInboxMulticall } from "../IInbox";
...
export class IInbox__factory {
  ...
  static multicall(address: string): IInboxMulticall {
    return new MulticallContract(address, _abi) as unknown as IInboxMulticall;
  }
}
