...
import type { IOutbox, IOutboxInterface, IOutboxMulticall } from "../IOutbox";
...
export class IOutbox__factory {
  ...
  static multicall(address: string): IOutboxMulticall {
    return new MulticallContract(address, _abi) as unknown as IOutboxMulticall;
  }
}
