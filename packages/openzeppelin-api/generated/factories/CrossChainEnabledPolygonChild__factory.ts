...
import type {
  ...
  CrossChainEnabledPolygonChildMulticall,
...
export class CrossChainEnabledPolygonChild__factory {
  ...
  static multicall(address: string): CrossChainEnabledPolygonChildMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as CrossChainEnabledPolygonChildMulticall;
  }
}
