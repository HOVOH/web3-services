...
import type { IVotes, IVotesInterface, IVotesMulticall } from "../IVotes";
...
export class IVotes__factory {
  ...
  static multicall(address: string): IVotesMulticall {
    return new MulticallContract(address, _abi) as unknown as IVotesMulticall;
  }
}
