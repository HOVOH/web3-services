...
import type { IBridge, IBridgeInterface, IBridgeMulticall } from "../IBridge";
...
export class IBridge__factory {
  ...
  static multicall(address: string): IBridgeMulticall {
    return new MulticallContract(address, _abi) as unknown as IBridgeMulticall;
  }
}
