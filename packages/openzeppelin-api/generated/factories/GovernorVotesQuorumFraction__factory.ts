...
import type {
  ...
  GovernorVotesQuorumFractionMulticall,
...
export class GovernorVotesQuorumFraction__factory {
  ...
  static multicall(address: string): GovernorVotesQuorumFractionMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as GovernorVotesQuorumFractionMulticall;
  }
}
