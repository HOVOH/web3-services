...
export interface IAMBMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  destinationChainId(overrides?: CallOverrides): Call<BigNumber>;
  ...
  maxGasPerTx(overrides?: CallOverrides): Call<BigNumber>;
  ...
  messageId(overrides?: CallOverrides): Call<string>;

  messageSender(overrides?: CallOverrides): Call<string>;

  messageSourceChainId(overrides?: CallOverrides): Call<string>;

  sourceChainId(overrides?: CallOverrides): Call<BigNumber>;

  transactionHash(overrides?: CallOverrides): Call<string>;
}
