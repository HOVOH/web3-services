...
export interface UniswapV2FactoryMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  allPairs(arg0: BigNumberish, overrides?: CallOverrides): Call<string>;

  allPairsLength(overrides?: CallOverrides): Call<BigNumber>;

  feeTo(overrides?: CallOverrides): Call<string>;

  feeToSetter(overrides?: CallOverrides): Call<string>;

  getPair(arg0: string, arg1: string, overrides?: CallOverrides): Call<string>;
}
