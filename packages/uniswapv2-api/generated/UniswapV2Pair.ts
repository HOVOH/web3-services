...
export interface UniswapV2PairMulticall {
  address: string;
  abi: Fragment[];
  ...
  PERMIT_TYPEHASH(overrides?: CallOverrides): Call<string>;
  ...
  balanceOf(arg0: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  kLast(overrides?: CallOverrides): Call<BigNumber>;

  name(overrides?: CallOverrides): Call<string>;

  nonces(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  price0CumulativeLast(overrides?: CallOverrides): Call<BigNumber>;

  price1CumulativeLast(overrides?: CallOverrides): Call<BigNumber>;
