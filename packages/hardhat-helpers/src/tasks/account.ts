...
import { findFirstAddress, getAccountData } from '../helpers/accounts';
import { DEBUG } from '../helpers/debug';

import { getMnemonic } from '../helpers/mnemonic';
...
task('secret', "Prints the account's secret key").setAction(
  async (taskArgs: { account: string }, hre: THardhatRuntimeEnvironmentExtended) => {
