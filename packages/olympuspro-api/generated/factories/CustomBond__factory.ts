...
export class CustomBond__factory {
  static readonly abi = _abi;
  static createInterface(): CustomBondInterface {
    return new utils.Interface(_abi) as CustomBondInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CustomBond {
    return new Contract(address, _abi, signerOrProvider) as CustomBond;
  }
  static multicall(address: string): CustomBondMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as CustomBondMulticall;
  }
}
